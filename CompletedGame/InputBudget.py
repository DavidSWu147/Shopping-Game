...
class InputBudget(object):
    ...
    def __init__(self, mC):
        ...
        self.recommendedBudgets = {'':(0,0),'Food':(20,30),'Home':(120,150),'Entertainment':(50,60)}
    ...
    def handleEvent(self,event):
        ...
        self.masterClass.overallStoreMap.budgetObj.setBudget("Budget: ", self.initialBudget, "freesansbold.ttf", 14)
        self.masterClass.overallStoreMap.remainingObj.setRemaining("Remaining: ", self.initialBudget, "freesansbold.ttf", 14)
        self.draw()
